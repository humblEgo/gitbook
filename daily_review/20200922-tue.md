...
## include "container\_test.hpp"

## include

## include "List.hpp"

static bool comparator\(SampleClass first, SampleClass second\) { return \(first.getName\(\) &lt; second.getName\(\)\); }

static bool unary\_predicator\(SampleClass target\) { return \(target.getName\(\) == "five"\); }

static bool binary\_predicate\(SampleClass first, SampleClass second\) { return \(first.getName\(\) == second.getName\(\)\); }

template  std::ostream& operator&lt;&lt;\(std::ostream& out, const ft::List& li\) { std::cout&lt;&lt;"============================================="&lt;::ConstIterator it = li.begin\(\); it != li.end\(\); ++it\) std::cout&lt;&lt;\*it&lt;&lt;" "; std::cout&lt;&lt;"\]"&lt;&lt;std::endl; std::cout&lt;&lt;"============================================="; return \(out\); }

void listTest\(\) { std::string data\[10\] = { "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten" };
